...
{
    // Msagl's SvgGraphWriter with our label-writing override (multi-line tspans, sanitised text). Tied
    // to Microsoft.Msagl.Drawing - an Msagl implementation detail of the SVG render path, not part of
