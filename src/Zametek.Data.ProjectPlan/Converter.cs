...
namespace Zametek.Data.ProjectPlan
{
    public static class Converter
    {
        ...
        public static v0_2_1.ProjectPlanModel Format(Common.ProjectPlan.ProjectPlanModel projectPlan)
        {
            return m_Mapper.Map<Common.ProjectPlan.ProjectPlanModel, v0_2_1.ProjectPlanModel>(projectPlan);
        }

        public static Common.ProjectPlan.ProjectPlanModel Upgrade(v0_2_1.ProjectPlanModel projectPlan)
        {
            return m_Mapper.Map<v0_2_1.ProjectPlanModel, Common.ProjectPlan.ProjectPlanModel>(projectPlan);
        }
