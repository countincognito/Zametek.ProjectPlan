...
namespace Zametek.Data.ProjectPlan
{
    public static class Converter
    {
        ...
        public static v0_4_2.ProjectPlanModel Format(Common.ProjectPlan.ProjectPlanModel projectPlan)
        {
            ArgumentNullException.ThrowIfNull(projectPlan);
            return m_Mapper.Map<Common.ProjectPlan.ProjectPlanModel, v0_4_2.ProjectPlanModel>(projectPlan);
        }

        public static Common.ProjectPlan.ProjectPlanModel Upgrade(v0_4_2.ProjectPlanModel projectPlan)
        {
            ArgumentNullException.ThrowIfNull(projectPlan);
            return m_Mapper.Map<v0_4_2.ProjectPlanModel, Common.ProjectPlan.ProjectPlanModel>(projectPlan);
        }
