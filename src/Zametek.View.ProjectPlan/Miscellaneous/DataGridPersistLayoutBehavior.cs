...
{
    // Persists a DataGrid's column layout (display order and width) via IDataGridLayoutManager,
    // keyed by grid name, and restores it when the grid is (re)loaded. The vertical scroll
    // position is handled separately by DataGridPersistScrollBehavior.
    public class DataGridPersistLayoutBehavior
        : Behavior<DataGrid>
    {
        private readonly Lock m_Lock;
        private string m_GridName;
        private DataGridModel m_OriginalGridModelModel;
        private readonly IDataGridLayoutManager m_DataGridManager;
        private readonly Dictionary<DataGridColumn, string> m_HeaderTextCache;
        private DataGrid? m_DataGrid;
        private bool m_IsInitialized;

        public DataGridPersistLayoutBehavior(IDataGridLayoutManager dataGridManager)
        {
