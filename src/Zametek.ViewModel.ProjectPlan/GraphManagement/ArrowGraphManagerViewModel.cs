...
namespace Zametek.ViewModel.ProjectPlan
{
        ...
        : ToolViewModelBase, IArrowGraphManagerViewModel, IGraphHost
    {
        ...
        public Task WriteFixedLayoutArrowGraphImageAsync(Stream stream, GraphExportFormat format)
        {
            return m_Interactive.WriteImageAsync(stream, format.ToGraphFileFormat(), GraphImageSource.FixedLayout, FixedLayoutGraphType.Arrow);
        }
        ...
        // activity-derived event id (BuildEventIdLookup; see ArrowEventIdMapper). Recording the pushed
        // instance in m_PushedLayout lets the seed subscription identify the resulting Core-layout
        // change as self-induced and ignore it rather than re-seeding.
