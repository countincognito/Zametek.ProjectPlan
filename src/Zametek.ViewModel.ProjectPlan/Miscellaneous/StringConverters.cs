...
namespace Zametek.ViewModel.ProjectPlan
{
    ...
    {
        public static readonly Func<string?, string?, bool> IsMatch =
            new((x, y) => string.Equals(x, y, StringComparison.InvariantCulture));

        public static readonly Func<LogicalOperator, string> LogicalOperatorValue =
            new(
                x => x switch
                {
        ...
        public static readonly Func<GroupByMode, string> GroupByModeValue =
            new(
                x => x switch
                {
        ...
        public static readonly Func<AnnotationStyle, string> AnnotationStyleValue =
            new(
                x => x switch
                {
        ...
        public static readonly Func<AllocationMode, string> AllocationModeValue =
            new(
                x => x switch
                {
        ...
        public static readonly Func<ScheduleMode, string> ScheduleModeValue =
            new(
                x => x switch
                {
        ...
        public static readonly Func<DisplayStyle, string> DisplayStyleValue =
            new(
                x => x switch
                {
        ...
        public static readonly Func<TrackedMetrics, string> TrackedMetricsValue =
            new(
                x => x switch
                {
        ...
        public static readonly Func<CurveFittingType, string> CurveFittingTypeValue =
            new(
        ...
        public static readonly Func<RecurrenceFrequency, string> RecurrenceFrequencyValue =
            new(
