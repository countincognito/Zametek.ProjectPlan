...
namespace Zametek.ViewModel.ProjectPlan
{
        ...
        : ViewModelBase, IActivityEditViewModel
    {
        ...
        private bool m_IsHasNoRiskActive;
        public bool IsHasNoRiskActive
        {
            get => m_IsHasNoRiskActive;
            set
            {
                m_IsHasNoRiskActive = value;
                this.RaisePropertyChanged();
            }
        }
        ...
        public UpdateDependentActivityModel BuildUpdateModel()
        {
            var updateModel = new UpdateDependentActivityModel
            {
                ...
                HasNoRisk = HasNoRisk,
                IsHasNoRiskEdited = IsHasNoRiskActive,
