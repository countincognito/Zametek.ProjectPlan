...
namespace Zametek.ViewModel.ProjectPlan.Tests
{
    public static class RecurrenceRuleFixture
    {
        ...
        [
            ...
            "FREQ=MONTHLY;INTERVAL=3;UNTIL=20251231T000000;BYMONTHDAY=10",
        ...
        [
            ...
            new() { Frequency = RecurrenceFrequency.Monthly, Interval = 3, ByMonthDay = [10], Until = new DateTime(2025, 12, 31, 0, 0, 0, DateTimeKind.Local) },
            ...
            new() { Frequency = RecurrenceFrequency.Daily, Until = new DateTime(2026, 12, 31, 0, 0, 0, DateTimeKind.Local) },
            new() { Frequency = RecurrenceFrequency.Daily, Until = new DateTime(2026, 12, 31, 23, 59, 59, DateTimeKind.Local) },
